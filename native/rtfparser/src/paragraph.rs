...
#[derive(Debug, Default, Clone, PartialEq, NifStruct)]
#[module = "RtfParser.Paragraph"]
...
#[derive(Debug, Default, Clone, Copy, PartialEq, NifTaggedEnum)]
pub enum Alignment {
    #[default]
    LeftAligned,
    RightAligned,
...
#[derive(Default, Debug, Clone, PartialEq, NifTaggedEnum)]
